...
class PrefsManager private constructor(context: Context) {
    ...
    companion object {
        private const val PREFERENCES = "CHIT_CHAT_PREFS"
...
//    fun setColorsArray(unitList: ArrayList<ColorModel>?) {
//        val editor = preferences.edit()
//        val gson = Gson()
//        val json = gson.toJson(unitList)
//        editor.putString("colorsList", json).apply()
//        editor.apply()
//    }
//
//    fun getColorsArray(): ArrayList<ColorModel> {
//        val gson = Gson()
//        val type = object : TypeToken<ArrayList<ColorModel?>?>() {}.type
//        return gson.fromJson(getColorModels(), type)
//    }
//
//    fun getColorModels(): String {
//        val unitList = ArrayList<String>()
//        val gson = Gson()
//        val str = gson.toJson(unitList)
//        return preferences.getString("colorsList", str).toString()
//    }
}
